...
export const userIsAuthenticated = authWrapper(userIsAuthenticatedDefaults)
...
export const userIsNotAuthenticated = authWrapper(userIsNotAuthenticatedDefaults)
